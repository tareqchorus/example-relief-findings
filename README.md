# Example Relief International — demo audience study
...
Built from `../model/` — `build_model.py` holds the economics, `build_pages.py`
assembles the pages from the Feeding America chart engine.
